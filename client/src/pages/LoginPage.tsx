      ...
      >
        <Card>
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl">Welcome to VitalAI</CardTitle>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4" noValidate>
              ...
              <div className="space-y-2">
                <label htmlFor="login-email" className="text-sm text-text-muted">Email</label>
              ...
              <div className="space-y-2">
                <label htmlFor="login-password" className="text-sm text-text-muted">Password</label>
                <div className="relative">
              ...
              <p className="text-center text-sm text-text-muted">
                ...
                <Link to="/register" className="text-primary hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 rounded">
                  Sign up
                </Link>
              </p>
            </form>
